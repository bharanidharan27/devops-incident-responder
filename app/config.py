...
CLOUDWATCH_LOG_GROUPS = os.getenv("CLOUDWATCH_LOG_GROUPS", CLOUDWATCH_LOG_GROUP)
CLOUDWATCH_STREAM_PREFIX = os.getenv("CLOUDWATCH_STREAM_PREFIX", "")
CLOUDWATCH_FILTER_PATTERN = os.getenv("CLOUDWATCH_FILTER_PATTERN", "")
CLOUDWATCH_LOOKBACK_MINUTES = int(os.getenv("CLOUDWATCH_LOOKBACK_MINUTES", "30"))
CLOUDWATCH_MAX_EVENTS = int(os.getenv("CLOUDWATCH_MAX_EVENTS", "100"))
CLOUDWATCH_FALLBACK_TO_LOCAL = _bool_env("CLOUDWATCH_FALLBACK_TO_LOCAL", True)
CLOUDWATCH_SIMULATION_RETENTION_DAYS = int(os.getenv("CLOUDWATCH_SIMULATION_RETENTION_DAYS", "1"))
